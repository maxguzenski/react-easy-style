...
function EasyStyle(styleOrClass) {
  var rootName = arguments.length <= 1 || arguments[1] === undefined ? 'root' : arguments[1];

  var isClass = isClassNames(styleOrClass);

  var tranverse = function tranverse(node, level, getClasesAndStyles) {
  ...
  var defaultGetClassesAndStyles = function defaultGetClassesAndStyles(node, isRoot) {
